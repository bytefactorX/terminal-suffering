# Terminal Suffering Change Log

I'm keeping a change log for my own sanity throughout the project. I went into this thing believing that I knew C, and turns out that is horribly, horribly wrong. I've been working on a literal sound engine in Python but am struggling to create a text-based game in C, the joys of having rocks for brains. 
...
### Added
- Foundation for dungeon.h & dungeon.c
